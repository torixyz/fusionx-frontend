...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.ENDURANCE]: '0xD91Fe561555B07b773951a59Af35dd52127cCD2a',
  [ChainId.ENDURANCE_TESTNET]: '0xBDd5e7e9E9887cCaFEf31BbeA56788781671646E',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.ENDURANCE]: '0xcD992daD8d2a7c3c06Ba08cE914D29df224006bF',
  [ChainId.ENDURANCE_TESTNET]: '0xf68B1cd461Da5DC43354d52A96EA811Fdaf97797',
} as const satisfies Record<ChainId, Address>
