...
export function getV3Subgraphs({ noderealApiKey }: SubgraphParams) {
  return {
    ...
    [ChainId.ENDURANCE_TESTNET]: 'https://endurance-subgraph-testnet.fusionist.io/subgraphs/name/tesseract/exchange-v3',
...
export function getBlocksSubgraphs({ noderealApiKey }: SubgraphParams) {
  return {
    ...
    [ChainId.ENDURANCE_TESTNET]: 'https://endurance-subgraph-testnet.fusionist.io/subgraphs/name/blocks',
  }
}
