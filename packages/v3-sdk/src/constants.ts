...
export const FACTORY_ADDRESSES = {
  ...
  [ChainId.ENDURANCE_TESTNET]: '0xd57C17d5Aa1912Fce0e6aA3d43b48817AB569aB6',
...
export const DEPLOYER_ADDRESSES = {
  ...
  [ChainId.ENDURANCE]: '0xD11b5DaAcee0FD2469Ee4548D7a7DC5bdfA5B6F0',
  [ChainId.ENDURANCE_TESTNET]: '0xC2b5d82b58e88E7062FFD2716bEC6bdcc7029925',
} as const satisfies Record<ChainId, Address>
...
export const POOL_INIT_CODE_HASHES = {
  ...
  [ChainId.ENDURANCE_TESTNET]: POOL_INIT_CODE_HASH,
...
export const NFT_POSITION_MANAGER_ADDRESSES = {
  ...
  [ChainId.ENDURANCE]: '0xEA90c48810952f63cF3F51Dc2756143B26063516',
  [ChainId.ENDURANCE_TESTNET]: '0x0668F440Bf9790C2AF06F283292B8B4ab68256da',
} as const satisfies Record<ChainId, Address>
